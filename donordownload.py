    ...
    if os.path.exists(fleMasterPath):
        if dlg.yesno("PseudoTV Live", "Update Donor Features?"):
            try:
                ...
                pass
            xbmc.executebuiltin("Notification( %s, %s, %d, %s)" % ("PseudoTV Live", "Donor Features Updating\nThank you for your support...", 4000, thumb) )
            DonorDownload = True           
    else:
        xbmc.executebuiltin("Notification( %s, %s, %d, %s)" % ("PseudoTV Live", "Donor Features Activating\nThank you for your support...", 4000, thumb) )
        DonorDownload = True    
...
if DonorInstall == True:
    xbmc.executebuiltin("Notification( %s, %s, %d, %s)" % ("PseudoTV Live", "Donor Features Enabled!\nXBMC Restart Required", 4000, thumb) )
else:
    xbmc.executebuiltin("Notification( %s, %s, %d, %s)" % ("PseudoTV Live", "Not All Features Installed\nTry Again Later...", 4000, thumb) )
